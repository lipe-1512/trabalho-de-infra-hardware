...
// ===== MECANISMO DE RESET INICIAL AUTOMÁTICO =====
reg rst_init = 1'b1;
wire rst_efetivo = reset | rst_init;
initial begin
    #1 rst_init = 1'b0;
end
...
.um(A_out),
.dois(Alu_res),
.tres({pc_out[31:28], jump_shift[27:0]}),
.quatro(Alu_res),
.cinco(EPC_out),
.escolha(PC_Source),
.saida_PCSource(PC_source_res)
...
.local({4'b0000, jump_instruction, 2'b00}),
.out_Sl(jump_shift)
);
// ===== DIVISOR =====
div division (
