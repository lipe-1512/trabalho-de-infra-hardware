...
constant INIT_FILE  : STRING  := "C:/Users/felip/OneDrive/Documents/faculdade/infra hard/2026.1/trabalho-de-infra-hardware/Componentes do Projeto/instrucoes.mif";
end ram_constants;
--*************************************************************************
library IEEE;
...
signal add3			: integer;
BEGIN
-- Cálculo dos 4 endereços com verificação de limites
add0 <= TO_INTEGER(unsigned(Address(7 downto 0))) when unsigned(Address(7 downto 0)) < 256 else 0;
add1 <= (TO_INTEGER(unsigned(Address(7 downto 0))) + 1) when unsigned(Address(7 downto 0)) < 255 else 0;
add2 <= (TO_INTEGER(unsigned(Address(7 downto 0))) + 2) when unsigned(Address(7 downto 0)) < 254 else 0;
add3 <= (TO_INTEGER(unsigned(Address(7 downto 0))) + 3) when unsigned(Address(7 downto 0)) < 253 else 0;
...
-- Bancos de memórias com intended_device_family
MEM: lpm_ram_dq
GENERIC MAP (
